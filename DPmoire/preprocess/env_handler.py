...
class EnvironmentHandler:
    ...
    def gen_environment(self, INCAR, out_dir:str, stackings:list=None):
        ...
        os.system(f"cp {self.input_dir}/ML_AB {top_dir}")
        os.system(f"cp {self.input_dir}/ML_FF {top_dir}")
        ...
        os.system(f"cp {self.input_dir}/ML_AB {bot_dir}")
        os.system(f"cp {self.input_dir}/ML_FF {bot_dir}")
